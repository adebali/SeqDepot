...
os.system("python3 loadAseqsJson.py " + pjson + " -id gi -col aseqs || exit 1")
...
###
#os.system("./createSuperJob-v1.pl -C superjobs -t segs,coils,agfam1,das,ecf,pfam28,tigrfam15 " + JOBNAME + " ||exit 1")
