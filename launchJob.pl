...
foreach my $batch (sort @$batches) {
	...
	system('/lustre/projects/zhulin/lulrich/bin/fasplit', '-n', $g_SplitSize, '-d', $seqFile);
...
sub sgeCommandsForTool {
    ...
    elsif ($toolName eq 'tigrfam14') {
	return &sge_tigrfam14();
    }
...
#\$ -l h_vmem=2G,h_stack=128M

set HMMSEARCH=/lustre/projects/zhulin/lulrich/tools/hmmer-2.4i/src/hmmpfam
set AGFAM=/lustre/projects/zhulin/lulrich/db/hmm/agfam/agfam.bin
...
set TOOL=/lustre/projects/zhulin/lulrich/tools/coils2/coils2
set PARSER=/lustre/projects/zhulin/lulrich/seqdepot/scripts/segsOrCoils2pseudo_json.pl
...
sub sge_das {
    return <<DAS;
#\$ -l mem=4G,h_vmem=4G,h_stack=128M

set TOOL=/lustre/projects/zhulin/lulrich/tools/das/das32
...
set HMMSEARCH=/lustre/projects/zhulin/lulrich/tools/hmmer-3.0/src/hmmsearch
set PFAM=/lustre/projects/zhulin/lulrich/db/hmm/pfam/26.0/pfam-a.hmm
...
set HMMSEARCH=/lustre/projects/zhulin/lulrich/tools/hmmer-3.1b1/binaries/hmmsearch
set PFAM=/lustre/projects/zhulin/lulrich/db/hmm/pfam/27.0/pfam-a.hmm
set TBLFILE=\$OUT_DIR/\$BASEINFILE.domtbl
...
set HMMSEARCH=/lustre/projects/zhulin/lulrich/tools/hmmer-3.1b1/binaries/hmmsearch
set PFAM=/lustre/projects/ogun_data/seqdepot/db/TIGRFAM_14.hmm
set TBLFILE=\$OUT_DIR/\$BASEINFILE.domtbl
...
set TOOL=/lustre/projects/zhulin/lulrich/tools/seg/seg
set PARSER=/lustre/projects/zhulin/lulrich/seqdepot/scripts/segsOrCoils2pseudo_json.pl
